...
# Additive Fitness effects
	...
	# No Inbreeding depression (delta = 0)
		...
		# C = 0
		sim2PatchSgrad(n = n, C = 0,   delta = delta, hf1 = h, hf2 = h, hm1 = h, hm2 = h, sMax=1, resolution = 0.01)
		# C = 1/4
		sim2PatchSgrad(n = n, C = 1/4, delta = delta, hf1 = h, hf2 = h, hm1 = h, hm2 = h, sMax=1, resolution = 0.01)
		# C = 1/2
		sim2PatchSgrad(n = n, C = 1/2, delta = delta, hf1 = h, hf2 = h, hm1 = h, hm2 = h, sMax=1, resolution = 0.01)
		# C = 3/4
		sim2PatchSgrad(n = n, C = 3/4, delta = delta, hf1 = h, hf2 = h, hm1 = h, hm2 = h, sMax=1, resolution = 0.01)
