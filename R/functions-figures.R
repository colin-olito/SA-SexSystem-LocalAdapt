...
# Figure comparing deterministic simulations of recursions with
# eigenvalue invasion analysis for the multipatch model.
compareEigSimPolyMultiPatchHDelta  <-  function(h, delta, sMax=1) {
...
## Panel A: C = 0
    par(omi=c(0.75, 0.75, 0.75, 0.75), mar = c(2.5,2.5,0.5,0.5), bty='o', xaxt='s', yaxt='s')    
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data1, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data1, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data1, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data1, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data1, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data1, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data1, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data1, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data1, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data1, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1, labels=NA)
        axis(2, las=1)
        # Plot labels etc.
...
## Panel B: C = 1/4
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data2, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data2, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data2, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data2, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data2, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data2, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data2, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data2, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data2, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data2, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1, labels=NA)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
## Panel C: C = 1/2
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data3, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data3, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data3, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data3, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data3, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data3, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data3, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data3, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data3, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data3, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1, labels=NA)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
## Panel D: C = 3/4
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data4, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data4, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data4, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data4, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data4, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data4, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data4, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data4, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data4, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data4, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1, labels=NA)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
## Panel E: C = 0
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data5, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data5, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data5, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data5, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data5, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data5, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data5, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data5, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data5, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data5, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1)
        # Plot labels etc.
...
## Panel F: C = 1/4
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data6, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data6, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data6, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data6, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data6, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data6, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data6, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data6, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data6, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data6, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
## Panel G: C = 1/2
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data7, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data7, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data7, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data7, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data7, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data7, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data7, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data7, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data7, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data7, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
## Panel H: C = 3/4
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # Plot proportion of parameter space for 1 and 2 patches
        points(pEigPoly5 ~ sMax, data=data8, pch=21, col=COLS[1])
        points(pEigPoly4 ~ sMax, data=data8, pch=21, col=COLS[2])
        points(pEigPoly3 ~ sMax, data=data8, pch=21, col=COLS[3])
        points(pEigPoly2 ~ sMax, data=data8, pch=21, col=COLS[4])
        points(pEigPoly1 ~ sMax, data=data8, pch=21, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=data8, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=data8, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=data8, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=data8, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=data8, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
# Simple figs for 2-patch Levene model for simultaneous hermaphrodites
compareEigLinesSimPolyMultiPatchHDelta  <-  function(h, delta, sMax=1) {
    ...
    dat5       <-  read.csv(filename5, header=TRUE)
    dat6       <-  read.csv(filename6, header=TRUE)
    dat7       <-  read.csv(filename7, header=TRUE)
...
## Panel E: C = 0
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        lines(poly2 ~ sMax, data=data5, lwd=2, col=COLS[4])
        lines(poly1 ~ sMax, data=data5, lwd=2, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=dat5, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=dat5, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=dat5, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=dat5, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=dat5, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1)
        # Plot labels etc.
...
## Panel F: C = 1/4
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        lines(poly2 ~ sMax, data=data6, lwd=2, col=COLS[4])
        lines(poly1 ~ sMax, data=data6, lwd=2, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=dat6, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=dat6, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=dat6, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=dat6, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=dat6, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
## Panel G: C = 1/2
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        lines(poly2 ~ sMax, data=data7, lwd=2, col=COLS[4])
        lines(poly1 ~ sMax, data=data7, lwd=2, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=dat7, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=dat7, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=dat7, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=dat7, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=dat7, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
...
## Panel H: C = 3/4
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0, sMax), ylim = c(0,1), ylab='', xlab='', cex.lab=1.2)
        ...
        lines(poly2 ~ sMax, data=data8, lwd=2, col=COLS[4])
        lines(poly1 ~ sMax, data=data8, lwd=2, col=COLS[5])
        points(pSimPoly5 ~ sMax, data=dat8, pch=21, bg=transparentColor(COLS[1], opacity=0.8))
        points(pSimPoly4 ~ sMax, data=dat8, pch=21, bg=transparentColor(COLS[2], opacity=0.8))
        points(pSimPoly3 ~ sMax, data=dat8, pch=21, bg=transparentColor(COLS[3], opacity=0.8))
        points(pSimPoly2 ~ sMax, data=dat8, pch=21, bg=transparentColor(COLS[4], opacity=0.8))
        points(pSimPoly1 ~ sMax, data=dat8, pch=21, bg=transparentColor(COLS[5], opacity=0.8))
        # axes
        axis(1, las=1)
        axis(2, las=1, labels=NA)
        # Plot labels etc.
